...
function Cart() {
  ...
  return (
    <div className="w-full rounded-md px-6 py-5 bg-white md:-translate-y-14">
        ...
        <button onClick={openModal} className="px-4 py-2 bg-amber-800 rounded-full w-full text-white text-lg hover:opacity-90 active:scale-99 cursor-pointer transition duration-75">Confirm Order</button>
    </div>
  )
}
